...
def render():
    ...
    <div class="explain-box">
        ...
        candidates. At each period, it <em>phase-folds</em> the light curve — stacking every
...
notch out of cardboard — the width set to a trial transit duration — and drag it along
...
grid of up to 200,000 candidates. It uses a fast frequency-domain algorithm, but
